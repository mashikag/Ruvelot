...
import { CurrencyExchangeActionTypes, ExchangeRates, SET_EXCHANGE_FROM_CURRENCY, SET_EXCHANGE_TO_CURRENCY, FETCH_CURRENCY_RATES_REQUEST, FETCH_CURRENCY_RATES_SUCCESS, FETCH_CURRENCY_RATES_FAILURE } from "./types"
...
let fetchExchangeRatesIntervalTimer: NodeJS.Timeout
...
export function fetchExchangeRatesSuccess(baseCurrency: Currency, exchangeRates: ExchangeRates):
    CurrencyExchangeActionTypes {
    return {
...
export function startFetchExchangeRatesInterval(callback?: (fetchDispatchPromise: Promise<void>) => void):
    ThunkAction<NodeJS.Timeout, {}, {}, AnyAction> {
    return (dispatch: ThunkDispatch<{}, {}, AnyAction>) => {
