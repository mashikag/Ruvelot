...
export function selectCurrencyAccount(currency: Currency):
  CurrencyAccountActionTypes {
  return {
...
export function setCurrencyAccountBalance(balance: Number, currency: Currency):
  CurrencyAccountActionTypes {
  return {
